...
KAFKA_BOOTSTRAP_SERVERS = ['localhost:49092', 'localhost:29092', 'localhost:39092']
...
csv_files = {
    'AIR': r"C:\GIT\Distributed Systems LAB\LAB1_DS\Partition 1\AIR_Consumer_1.csv",
    'EARTH': r"C:\GIT\Distributed Systems LAB\LAB1_DS\Partition 1\EARTH_Consumer_1.csv",
    'WATER': r"C:\GIT\Distributed Systems LAB\LAB1_DS\Partition 1\WATER_Consumer_1.csv"
}
...
def consume_data():
    ...
    partitions = [TopicPartition(topic, 1) for topic in KAFKA_TOPICS]
